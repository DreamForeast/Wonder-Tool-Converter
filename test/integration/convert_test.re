  ...
  describe("convert", () => {
    ...
    describe("convert gltf file to wd file", () =>
      test("test", () => {
        ...
        |>
        expect == {|[["2.0","GLTF2WD"],[[0],0],[[[[0],[[1]]],[[0,1],[0,1]],[[],[]],[[],[]],[[1],[0]],[[],[]],[[],[]],[[1],[0]]],[[[0],[0]]],[[0],[0]],[[0],[0]]],[2,["gameObject_0","Mesh"]],[[[3,"image/png"]]],[["CesiumLogoFlat.png",1]],[[1,4,2,2]],[24360],[[0,768,72,0],[0,0,576,[12]],[0,576,192,[8]],[0,840,23516,0]],[[0,0,36,3,0],[1,0,24,5,2],[1,288,24,5,2],[2,0,24,5,1]],[],[],[0],[],[[[[0,0,0]],[[-0.7071067811865475,0,0,0.7071067811865476]],[[1,1,1]]],[0,0,0]],[[[2,[1],[3],0]]],[[[1,1,1],"Texture"]]]|};
      })
    );
  });